...
import { AgentSession, EventBus, ToolRegistry } from "@live2d-agent/agent-core";
import { OpenAiCompatibleAdapter } from "@live2d-agent/model-openai-compatible";
import { createDefaultTools } from "@live2d-agent/tools";
...
export class AgentService {
    ...
    result(action, startedAt, ok, content, data, code = "TOOL_ERROR") {
        return {
            actionId: action.id,
            tool: action.tool,
            ok,
